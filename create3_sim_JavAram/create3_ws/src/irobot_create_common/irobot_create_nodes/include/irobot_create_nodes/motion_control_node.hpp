...
private:
  ...
  /// \brief Callback for reset_pose service
  void reset_pose_request(
    const irobot_create_msgs::srv::ResetPose::Request::SharedPtr request,
    irobot_create_msgs::srv::ResetPose::Response::SharedPtr response);
  ...
  rclcpp::Service<irobot_create_msgs::srv::EStop>::SharedPtr e_stop_server_;
    /// \brief Service to reset pose robot, this will prevent robot from commanding velocity
  rclcpp::Service<irobot_create_msgs::srv::ResetPose>::SharedPtr reset_pose_server_;
