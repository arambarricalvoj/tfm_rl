  ...
  repeat_print_(1s)
{
  ...
  reset_pose_server_ = this->create_service<irobot_create_msgs::srv::ResetPose>(
  "reset_pose",
  std::bind(
    &MotionControlNode::reset_pose_request, this, std::placeholders::_1,
    std::placeholders::_2));
...
void MotionControlNode::reset_pose_request(
