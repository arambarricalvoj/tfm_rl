...
def generate_launch_description():
    ...
    #ld.add_action(joint_state_broadcaster_spawner) # In simulation we use Gazebo controller
    #ld.add_action(diffdrive_controller_callback) # In simulation we use Gazebo controller
