...
from ..common.settings import ENABLE_BACKWARD, EPISODE_TIMEOUT_SECONDS, ENABLE_MOTOR_NOISE, UNKNOWN, SUCCESS, TUMBLE, \
...
class DRLEnvironment(Node):
    def __init__(self):
        ...
        ************************************************************"""
        ...
        qos.reliability = ReliabilityPolicy.BEST_EFFORT # To fit current clock publisher
